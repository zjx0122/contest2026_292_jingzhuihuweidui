/****************************************************************************
 * boards/arm/stm32/STM32F407_HEALTH/include/board.h
 *
...
#ifndef __BOARDS_ARM_STM32_STM32F407_HEALTH_INCLUDE_BOARD_H
#define __BOARDS_ARM_STM32_STM32F407_HEALTH_INCLUDE_BOARD_H
...
/* The STM32F407_HEALTH board features a single 8MHz crystal.
 ...
 * board the STM32F407_HEALTH.  The following definitions describe how NuttX
 * controls the LEDs:
 */
...
/* The STM32F407_HEALTH supports one button: */
...
/* 普通串口模式下 USART1 引脚：PA9=TX，PA10=RX */
...
/* USART2:
 *
 * The STM32F407_HEALTH has no on-board serial devices, but the console is
...
/* PWM
 *
 * The STM32F407_HEALTH has no real on-board PWM devices, but the board
...
/* SPI1 - GC9A01 LCD 使用非默认引脚：PB3=SCK, PB5=MOSI */

#define GPIO_SPI1_MISO    GPIO_SPI1_MISO_2   /* PB4 (AF5, LCD 未使用) */
#define GPIO_SPI1_MOSI    GPIO_SPI1_MOSI_2   /* PB5 (AF5) */
#define GPIO_SPI1_SCK     GPIO_SPI1_SCK_2    /* PB3 (AF5) */

/* GC9A01 LCD 控制引脚 */

#define GPIO_LCD_DC  (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_50MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTD|GPIO_PIN7)
#define GPIO_LCD_RST (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_50MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTA|GPIO_PIN4)
...
/* I2C.  Only I2C1 is available on the STM32F407_HEALTH.  I2C1_SCL and
...
#endif
#define GPIO_VL53L0X_XSHUT \
    (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_2MHz | GPIO_OUTPUT_CLEAR | GPIO_PORTC | GPIO_PIN5)

#define GPIO_VL53L0X_GPIO1 \
...
/* ZERO CROSS pin definition — PD0 已改为 LED_PRESENCE，此定义禁用 */
...
/* LD2410B 雷达传感器 OUT 引脚 (PC0) */

#define GPIO_LD2410B_OUT \
  (GPIO_INPUT|GPIO_FLOAT|GPIO_PORTC|GPIO_PIN0)
...
#define GPIO_RADAR_PRESENCE \
    (GPIO_INPUT | GPIO_PULLDOWN | GPIO_EXTI | GPIO_PORTC | GPIO_PIN0)

/* 状态指示 LED */

#define GPIO_LED_PRESENCE \
    (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_2MHz | GPIO_OUTPUT_CLEAR | \
     GPIO_PORTD | GPIO_PIN0)

#define GPIO_LED_ALERT \
    (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_2MHz | GPIO_OUTPUT_CLEAR | \
...
#endif /* __BOARDS_ARM_STM32_STM32F407_HEALTH_INCLUDE_BOARD_H */
